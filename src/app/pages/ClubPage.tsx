          ...
          <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="grid gap-4 self-end">
              <div className="border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                ...
                <div className="mt-3 font-[var(--font-display)] font-semibold text-3xl uppercase tracking-tight">Supporter program</div>
              </div>
              <div className="border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                <div className="text-xs uppercase tracking-[0.28em] text-white/45">What It Is Not</div>
                <div className="mt-3 font-[var(--font-display)] font-semibold text-3xl uppercase tracking-tight">Not a paywall</div>
              </div>
              <div className="border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                <div className="text-xs uppercase tracking-[0.28em] text-white/45">Why Join</div>
                <div className="mt-3 font-[var(--font-display)] font-semibold text-3xl uppercase tracking-tight">Gear, status, first access</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                {hunnids.map((item) => (
                  <div key={item.action} className="flex items-center justify-between border border-[#0d1b28]/10 bg-white p-4">
                    ...
                    <span className="font-[var(--font-display)] font-semibold text-2xl uppercase tracking-tight text-[#EE455F]">
                      {item.value}
                    </span>
                  </div>
                ))}
