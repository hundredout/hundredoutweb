        ...
        <div className="relative max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="max-w-4xl">
            ...
            <p className="text-2xl text-white/70 max-w-2xl mb-12">
              Live scoring, side bets, trash talk, and rewards. The app built for golf the way you actually play it.
            </p>
            <div className="flex flex-wrap gap-4">
              <button className="px-8 py-4 bg-[#EE455F] text-white uppercase tracking-wide hover:bg-[#d63d54] transition-colors">
                Download for iOS
              </button>
              <button className="px-8 py-4 bg-white text-[#0d1b28] uppercase tracking-wide hover:bg-white/90 transition-colors">
        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="text-center mb-20">
            <h2 className="font-['Proxima_Nova'] text-5xl uppercase tracking-tight mb-6">
              Built for Real Rounds
            </h2>
            <p className="text-xl text-[#0d1b28]/60 max-w-2xl mx-auto">
              More features, more detail, more reasons to never play without it.
            </p>
          </div>
        </div>
      </section>
