        ...
        <div className="relative max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="max-w-4xl">
            ...
            <h1 className="font-[var(--font-display)] font-black text-[clamp(3rem,10vw,7rem)] leading-[0.9] tracking-tight uppercase mb-8">
              Stories From
              <br />
              <span className="text-[#EE455F]">The Course</span>
            </h1>
            <p className="text-2xl text-white/70 max-w-2xl">
              Tips, moments, and the kind of golf content that doesn't put you to sleep.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="text-center">
            ...
            <p className="text-xl text-[#0d1b28]/60 max-w-2xl mx-auto">
              Articles, guides, and stories from the HundredOut community.
            </p>
          </div>
        </div>
      </section>
