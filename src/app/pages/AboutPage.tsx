      ...
      <section className="relative overflow-hidden bg-[#0d1b28] pt-32 pb-24 text-white">
        ...
        <div className="relative mx-auto max-w-[1600px] px-6 lg:px-12">
          <div className="max-w-5xl">
            ...
            <h1 className="mb-8 font-['Proxima_Nova'] text-[clamp(3rem,10vw,7rem)] leading-[0.9] tracking-tight uppercase">
              Building
              <br />
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {advisors.map((advisor) => (
              ...
              >
                ...
                <div className="p-8">
                  <h3 className="font-['Proxima_Nova'] text-3xl uppercase tracking-tight text-[#0d1b28]">
                    {advisor.name}
                  </h3>
        ...
        <div className="mx-auto grid max-w-[1600px] gap-10 px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-12">
          <div className="relative overflow-hidden bg-[#0d1b28] text-white">
            ...
            <div className="relative flex min-h-[460px] flex-col justify-end p-8 md:p-12">
              ...
              <h2 className="font-['Proxima_Nova'] text-[clamp(2.5rem,7vw,5rem)] leading-[0.95] tracking-tight uppercase">
                It's About
                <br />
          ...
          <div className="flex flex-col justify-between border border-[#0d1b28]/10 bg-[#f6f8fb] p-8 md:p-10">
            <div>
              ...
              <a
                ...
                className="font-['Proxima_Nova'] text-3xl uppercase tracking-tight text-[#0d1b28] hover:text-[#EE455F] transition-colors"
              >
                info@hundredout.com
              </a>
