    ...
    <section className="relative py-32 bg-[#0d1b28] text-white overflow-hidden">
      ...
      <div className="relative max-w-[1200px] mx-auto px-6 lg:px-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <Link to="/app" className="group relative px-10 py-5 bg-[#EE455F] text-white uppercase tracking-wide text-lg overflow-hidden transition-all hover:scale-105 active:scale-95">
        ...
        {/* Platform Info */}
        <div className="flex flex-wrap items-center justify-center gap-8 text-white/40 text-sm uppercase tracking-wider">
